...
<head>
    ...
    <title>Bloom</title>
    <link rel="icon" type="image/x-icon" href="bloom2.png">
...
<body>
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container">
            <a class="navbar-brand" href="./index.php"><img src="Bloom.png" class="logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="search--div">
                    ...
                    <?php endif; ?>
                    <div id="node-id" class="node-id shadow-sm"></div>
                </div>
            </div>
        </div>
    </nav>
